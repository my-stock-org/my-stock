	 ...
	 private static Caissiers instance = null;
			...
			CreerButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent argo) {
	                 ...
	                 try {
	                	 ...
	                	 Statement aj =  BdConnection.connect.createStatement(); 
	                	  aj.executeUpdate(req);
	    
	     
	                	 // Statement aj=cnx.createStatement();
	                	
	                	 // PreparedStatement az=cnx.prepareStatement(req);
	                	// az.setString(2, textField.getText());
	                	// az.setString(3, textField_1.getText()); n 
	                	// az.setString(5, textField_3.getText());
	                	 //aj.executeUpdate(req);
		...
		// static Connection cnX() {
			// try {
				...
				// return DriverManager.getConnection("jdbc:mysql://localhost/mystock/caissier", "root", "");
			 //}
			// catch(Exception e) {
